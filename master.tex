...
\begin{frame}
	\frametitle{Vergleich der Frameworks}
	
	
	\begin{table}[h]
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			 & Django & TurboGear2.0 & web2py & Pylons  \\ \hline
		  	Routing & 
		  		\cellcolor{dkgreen} mächtig	& 																\cellcolor{dkgreen} einfach	&
		  		\cellcolor{dkgreen} einfach	&
		  		\cellcolor{dkgreen} einfach	\\ \hline
		 \end{tabular}
	\end{table}
