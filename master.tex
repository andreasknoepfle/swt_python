...
\frametitle{Turbogears }
  ...
  \begin{tikzpicture}[scale=0.88] % timeline 2003-2012->
    ...
    \fill (y2005) circle (3pt) node[above=3pt] {1.0};
    \fill (y2009) circle (3pt) node[above=12pt] {1.1};
  ...
  \item Module sind dabei austauschbar
  \end{itemize}
  \end{column}
   \begin{column}[T]{.5\textwidth}<1->
  \begin{figure}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}[<1->]
    ...
    \item Übersetzung in Python-Klassen, Templates und JS-Code
  \end{itemize}
  \begin{lstlisting}
  ...
  \end{beamerpostit}
    ...
    \begin{columns}<1->
            ...
            \begin{itemize}[<1->]
                ...
                \item Große Anzahl gleichzeitiger Verbindungen \todo{Arbeiten
                    Sie doch auch mal mit Bildern oder Screenshots.}
            \end{itemize}
